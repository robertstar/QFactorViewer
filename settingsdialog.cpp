...
//    m_ui->vidLabel->setText(tr("Идентификатор изготовителя: %1").arg(list.count() > 5 ? list.at(5) : tr(blankString)));
...
//    m_ui->baudRateBox->addItem(tr("Другая"));
...
//    m_ui->parityBox->addItem(tr("Нет"), QSerialPort::NoParity);
//    m_ui->parityBox->addItem(tr("Нечетный"), QSerialPort::EvenParity);
//    m_ui->parityBox->addItem(tr("Четный"), QSerialPort::OddParity);
//    m_ui->parityBox->addItem(tr("Отметка"), QSerialPort::MarkParity);
//    m_ui->parityBox->addItem(tr("Пробел"), QSerialPort::SpaceParity);
...
//    m_ui->flowControlBox->addItem(tr("Нет"), QSerialPort::NoFlowControl);
